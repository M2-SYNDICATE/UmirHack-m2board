    ...
    >
      ...
      <div class="px-6 py-4 border-b border-gray-200">
        <div class="flex items-center justify-between">
          <h3 class="text-xl font-semibold text-gray-900">Новая папка</h3>
        ...
        <p class="text-sm text-gray-500 mt-1">Создание новой папки проекта</p>
      </div>
      ...
      <div class="px-6 py-6">
        ...
        <div class="mb-6">
          ...
          <p class="text-xs text-gray-500 mt-1">
            Например: "Рекламная кампания 2025" или "Корпоративные видео"
          </p>
        </div>
        ...
        <div class="flex space-x-3">
          ...
          >
            ...
            <span>{{ isLoading ? 'Создание...' : 'Создать папку' }}</span>
          </button>
        </div>
      </div>
    </div>
